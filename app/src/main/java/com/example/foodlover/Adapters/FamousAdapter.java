...
public class FamousAdapter extends RecyclerView.Adapter<FamousAdapter.ViewHolders> {
    ...
    public void onBindViewHolder(@NonNull ViewHolders holder, int position) {
        ...
        holder.btn_add_to_wishlist_light.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                product_id = String.valueOf(data.get(position).getId());
                Log.e("light", product_id);
                holder.btn_add_to_wishlist_light.setVisibility(View.GONE);
                holder.btn_add_to_wishlist_dark.setVisibility(View.VISIBLE);
                add_to_wishlist(user_id, product_id);
            }


        });
        holder.btn_add_to_wishlist_dark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                product_id = String.valueOf(data.get(position).getId());
                Log.e("dark", product_id);
                holder.btn_add_to_wishlist_dark.setVisibility(View.GONE);
                holder.btn_add_to_wishlist_light.setVisibility(View.VISIBLE);
